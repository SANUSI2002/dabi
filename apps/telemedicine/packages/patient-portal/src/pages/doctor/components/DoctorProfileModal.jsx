        ...
        <div className="sabi-profile-body">
          ...
          <aside className="sabi-profile-side">
            <div className="sabi-profile-side-card">
              ...
              <strong className="sabi-profile-side-fee">₦{doctor.fee.toLocaleString()}</strong>
              <span className="sabi-profile-side-next">Next available: {doctor.nextAvailable}</span>

              <button type="button" className="sabi-doctor-primary sabi-profile-book" onClick={() => onBook(doctor)}>
                Book Appointment
              </button>
